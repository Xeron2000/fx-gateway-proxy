...
GATEWAY_V3_URL = os.environ.get("UPSTREAM_URL", "https://ai-gateway.vercel.sh/v3/ai/language-model")
...
def get_default_api_key(explicit_key: str = "") -> str:
...
async def chat_completions(
    ...
    api_key = get_default_api_key(incoming_key)
